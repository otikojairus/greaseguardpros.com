...
export function FlameIcon({ className, size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M8.5 14.5A2.5 2.5 0 0011 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 11-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 003.5 0z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
const SERVICE_ICONS: Record<string, FC<IconProps>> = {
  hood: FlameIcon,
  "grease-trap": DropletIcon,
  "catch-basin": DropletIcon,
  "hydro-jetting": WrenchIcon,
  "lift-station": WrenchIcon,
  "commercial-kitchen": ShieldIcon,
  "kitchen-exhaust": FlameIcon,
};

export function ServiceIcon({ family, className, size = 28 }: IconProps & { family: string }) {
  const Icon = SERVICE_ICONS[family] ?? WrenchIcon;
